        ...
        <div className="flex justify-between w-full max-w-[860px] mx-auto">
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <Button
              ...
              className="px-6 py-6 text-base font-semibold border-2 border-gray-300 hover:border-[#ca5a8b] text-gray-700 hover:text-[#ca5a8b] hover:bg-gradient-to-r hover:from-[#ca5a8b]/10 hover:to-[#f2b347]/10 transition-all duration-300 rounded-full disabled:opacity-40 disabled:cursor-not-allowed"
            >
              ← Previous Step
            </Button>
          </motion.div>
          ...
          {!isLastStep ? (
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button
                className="px-8 py-6 text-base font-semibold bg-gradient-to-r from-[#6654f5] to-[#ca5a8b] text-white shadow-xl hover:opacity-90 transition-all duration-300 rounded-full"
                onClick={onComplete}
              >
                Mark as Complete →
              </Button>
              ...
              <Button
                className={`px-8 py-6 text-base font-semibold ${
                  projectCompleted
                    ...
                    : 'bg-gradient-to-r from-[#f2b347] to-[#ca5a8b] hover:opacity-90'

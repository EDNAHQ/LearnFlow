    ...
    <div className="z-10">
      <HoverCard openDelay={100} closeDelay={200}>
        <HoverCardTrigger asChild>
          <button 
            className="w-10 h-10 rounded-full bg-gradient-to-br from-[#6D42EF]/90 to-[#E84393]/90 flex items-center justify-center text-white shadow-md hover:shadow-lg transition-all group animate-pulse hover:animate-none"
